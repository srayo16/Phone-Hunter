  ...
  document.getElementById('noData').style.display = 'none';
    ...
    if(!phone.others){
      ...
      <div class="card-body">
        ...
        <p class="card-text"><span class= "fw-bold" >Realease Date:</span> ${phone.releaseDate ? phone.releaseDate: 'Coming soon'} </p>
        <p class="card-text"><span class= "fw-bold" >Main features:</span> Chipset: ${phone.mainFeatures.chipSet ? phone.mainFeatures.chipSet: 'Not available!'} <br>Display Size: ${phone.mainFeatures.displaySize ? phone.mainFeatures.displaySize: 'Not available!' } <br>Memory: ${phone.mainFeatures.memory ? phone.mainFeatures.memory: 'Not available!' } </p>
        <p class="card-text"><span class= "fw-bold" >Sensors:</span> ${phone.mainFeatures.sensors ? phone.mainFeatures.sensors: 'Not available!' }</p>
        <p class="card-text"><span class= "fw-bold" >Others:</span> Not available!</p>
        </div>
      </div>`;
